...
class ElectronicsCategories extends StatefulWidget {
  @override
  State<ElectronicsCategories> createState() => _ElectronicsCategoriesState();
}

class _ElectronicsCategoriesState extends State<ElectronicsCategories> {
  @override
      ...
      child: Scaffold(
        ...
        body: FutureBuilder<List<ProductModel>>(
          future: CategoriesService()
              .getCategoriesProduct(category_name: "electronics"),
