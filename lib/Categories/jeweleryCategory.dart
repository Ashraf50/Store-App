...
class jeweleryCategories extends StatefulWidget {
  @override
  State<jeweleryCategories> createState() => _jeweleryCategoriesState();
}

class _jeweleryCategoriesState extends State<jeweleryCategories> {
  @override
      ...
      child: Scaffold(
        ...
        body: FutureBuilder<List<ProductModel>>(
          future: CategoriesService()
              .getCategoriesProduct(category_name: "jewelery"),
